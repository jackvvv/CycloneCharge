...
/**
 * Created by 忧郁的眼神 on 2016/12/21 0021.
 */
...
//            Toast.makeText(getContext(), "安装有高德地图", Toast.LENGTH_SHORT).show();
    ...
    private static void SkipToGD(LatLng latLng) {
        ...
        Uri uri = Uri.parse("androidamap://navi?sourceApplication=CloudPatient&lat=" + latLng.latitude + "&lon=" +
                latLng.longitude + "&dev=1&style=2");
