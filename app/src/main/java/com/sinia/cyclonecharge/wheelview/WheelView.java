...
package com.sinia.cyclonecharge.wheelview;

import java.util.LinkedList;
import java.util.List;

import com.sinia.cyclonecharge.wheelview.adapter.WheelViewAdapter;
...
//			0xcfE9E9E9, 0x3fE9E9E9 };
	...
	private void drawCenterRect(Canvas canvas) {
        ...
        paint2.setColor(getResources().getColor(R.color.province_shape));
        // 绘制中间矩形
		canvas.drawRect(0,center - offset,getWidth(),center + offset, paint2);
		//*/
	}
