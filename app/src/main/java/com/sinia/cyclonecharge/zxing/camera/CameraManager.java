...
import com.sinia.cyclonecharge.zxing.open.OpenCameraInterface;
...
public final class CameraManager {
	...
	public synchronized Rect getFramingRect() {
		if (framingRect == null) {
			...
			/** modify here **/
			System.out.println("ScreenResolution: X-" + screenResolution.x
					+ "     Y-" + screenResolution.y);
			System.out.println("二维码width:" + width);
			System.out.println("二维码height:" + height);
			...
			int leftOffset = (screenResolution.x - width) / 2;
			// Jacky 2013-11-22
			// int topOffset = (screenResolution.y - height - dip2px(context,
			// 60) - PubData.titleBarHeight) / 2;
			int topOffset = (screenResolution.y - height - dip2px(context, 120)) / 2;
			framingRect = new Rect(leftOffset, topOffset, leftOffset + width,
					topOffset + height);
			/** modify end **/
