...
package com.sinia.cyclonecharge.zxing.view;
...
public final class ViewfinderView extends View {
	...
	public ViewfinderView(Context context, AttributeSet attrs) {
		...
		boxDrawable = getResources().getDrawable(R.mipmap.scan_box);
	}
	...
	public void onDraw(Canvas canvas) {
		...
		// // 左上角
		// canvas.drawRect(frame.left, frame.top, frame.left + 15, frame.top +
		// 5,
		// paint);
		// canvas.drawRect(frame.left, frame.top, frame.left + 5, frame.top +
		// 15,
		// paint);
		// // 右上角
